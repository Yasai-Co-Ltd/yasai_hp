...
export const metadata = {
  ...
  description:
    "YASAI株式会社の特定商取引法に基づく表記です。事業者情報、連絡先、料金、返品・キャンセルポリシーなどの情報を掲載しています。",
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            <section>
              ...
              <p className="text-gray-700 mb-4">YASAI株式会社</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold mb-4">運営統括責任者</h2>
              <Separator className="mb-6" />
              <p className="text-gray-700 mb-4">代表取締役 久保田凌介</p>
            </section>
            ...
            <section>
              ...
              <Separator className="mb-6" />
              <p className="text-gray-700 mb-4">
                クレジットカード決済、銀行振込、その他当社が定める方法によるものとします。
                <br />
            ...
            <section>
              ...
              <Separator className="mb-6" />
              <p className="text-gray-700 mb-4">
                各サービスの提供開始時期については、お申込み時にご案内いたします。
                <br />
            ...
            <section>
              ...
              <Separator className="mb-6" />
              <p className="text-gray-700 mb-4">
                サービスの性質上、お客様のご都合による返品・キャンセルはお受けできない場合があります。
                <br />
