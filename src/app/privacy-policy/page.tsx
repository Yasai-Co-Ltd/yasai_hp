...
export const metadata = {
  title: 'プライバシーポリシー | YASAI株式会社',
  description: 'YASAI株式会社のプライバシーポリシーです。当社のサービスにおけるユーザーの個人情報の取り扱いについて定めています。',
}
      ...
      <div className="yasai-container py-16">
        <div className="max-w-4xl mx-auto">
          <p className="text-gray-700 mb-8">
            YASAI株式会社(以下、「当社」といいます。) は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
          </p>
          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <ul className="list-disc pl-12 space-y-2 text-gray-700 mt-2">
